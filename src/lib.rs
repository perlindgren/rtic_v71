...
impl Usbd {
    ...
    fn open_ep(&self, ep_index: usize) {
        rprintln!("open_ep: ep_index {}", ep_index);

        // for now
        let ep_max_packet_size: usize = 64;

        rprintln!("ep_max_packet_size {}", ep_max_packet_size);
    ...
    #[inline(always)]
    fn fifo_addr(ep_index: usize) -> usize {
